...
<details>
<summary><b>🤖 Smart AI Assistant</b></summary>
<br />
Engage in natural conversation with an AI that asks about your fitness goals, physical condition, and preferences to create a personalized program. The assistant uses advanced voice recognition to understand and respond to your requests in real-time.
</details>

<details>
<summary><b>🏋️ Personalized Workout Plans</b></summary>
<br />
Get custom exercise routines based on your fitness level, existing injuries, equipment access, and personal goals. Each plan includes detailed instructions, rep counts, sets, and rest periods optimized for your specific needs.
</details>

<details>
<summary><b>🥗 Diet Recommendations</b></summary>
<br />
Receive tailored meal plans accounting for your allergies, dietary restrictions, and nutritional needs to complement your workout routine. Includes macro breakdowns, meal timing suggestions, and alternatives for dietary preferences.
</details>

<details>
<summary><b>🔐 User Authentication</b></summary>
<br />
Secure sign-in with GitHub, Google, or email/password through Clerk authentication. User data is protected and personalized to provide a seamless experience across devices.
</details>

<details>
<summary><b>📊 Program Management</b></summary>
<br />
Create and view multiple fitness programs with only the latest one active, allowing users to try different approaches. The responsive interface adapts to any screen size for easy access on mobile devices.
</details>

<details>
<summary><b>📱 Responsive Design</b></summary>
<br />
Beautiful UI with cyberpunk aesthetics that works flawlessly across desktop, tablet, and mobile devices. The layout adjusts dynamically to provide optimal viewing and interaction experience regardless of screen size.
</details>

<details>
<summary><b>🎬 Real-time Program Generation</b></summary>
<br />
Watch as your fitness program is generated in real-time with dynamic visual feedback. Progress indicators, animations, and sound effects create an immersive experience during the generation process.
</details>

<details>
<summary><b>🎭 Optimized Architecture</b></summary>
<br />
Strategic use of client and server components for optimal performance and user experience. Server components handle data-intensive operations while client components provide interactive UI elements for a smooth user experience.
</details>
